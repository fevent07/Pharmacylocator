    ...
    >
      <CDBSidebar textColor="#00AADB" backgroundColor="#000">
        <CDBSidebarContent className="sidebar-content">
          <CDBSidebarMenu>
            <NavLink exact to="/PharmaHome" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="home">Home</CDBSidebarMenuItem>
            </NavLink>
            <NavLink exact to="/ViewMedicine" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="list">View Medicine</CDBSidebarMenuItem>
            </NavLink>
            <NavLink exact to="/ManageMedicine" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="clipboard-check">Manage Medicine</CDBSidebarMenuItem>
            </NavLink>
